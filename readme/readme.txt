Este projeto analisa dados de acidentes de trânsito nos EUA usando Python, focando em padrões temporais, distribuição geográfica e severidade dos acidentes em diferentes estados.
